        ...
        <CardHeader>
          <CardTitle className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              <img className="w-12 rounded-md opacity-85" src={Logo} />
              <div>
                pgExplore
            ...
            <div className="w-[3rem] flex-shrink-0">Github</div>
          </CardTitle>
        </CardHeader>
        <CardContent className="flex gap-5 flex-col md:flex-row">
          <div className="flex flex-col gap-2">
            ...
            <div className="flex gap-2">
              <div className="flex flex-col p-2 border rounded-xl shadow items-center w-[13rem] select-none hover:bg-muted flex-1">
            ...
            {databases?.length === 0 ? (
              ...
              <div className="flex flex-col gap-2">
                {databases?.map((db) => (
                  <div
                    key={db.id}
                    className="flex items-center gap-2 p-1 hover:bg-gray-100 rounded-xl select-none"
